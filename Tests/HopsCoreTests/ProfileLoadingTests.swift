...
final class ProfileLoadingTests: XCTestCase {
    ...
    func testLoadDefaultProfile() throws {
        ...
        XCTAssertEqual(policy.capabilities.resourceLimits?.memoryBytes, 536870912)
    ...
    func testLoadUntrustedProfile() throws {
        ...
        XCTAssertEqual(policy.capabilities.resourceLimits?.memoryBytes, 268435456)
    ...
    func testLoadBuildProfile() throws {
        ...
        XCTAssertEqual(policy.capabilities.resourceLimits?.memoryBytes, 8589934592)
